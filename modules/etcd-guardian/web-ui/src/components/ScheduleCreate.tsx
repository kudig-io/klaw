...
const ScheduleCreate = () => {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-blue-400">Create Schedule</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-gray-700 p-4 rounded-lg shadow-md">
            ...
            <div className="space-y-3">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-1">Schedule (Cron Expression)</label>
                <input
                  type="text"
                  name="schedule"
                  ...
                  className="w-full px-3 py-2 bg-gray-800 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder="0 * * * *"
                  title="Cron expression format: minute hour dayOfMonth month dayOfWeek"
                />
                {errors.schedule && <p className="text-red-400 text-sm mt-1">{errors.schedule}</p>}
                <p className="text-gray-400 text-xs mt-1">Example: 0 * * * * (every hour)</p>
              </div>
